...
const LitPathAI = () => {
  ...
  const handleSearch = async (query = searchQuery) => {
    ...
    try {
      const response = await fetch(`${API_BASE_URL}/search`, {
        ...
        body: JSON.stringify({
          question: query,
          discipline: selectedDiscipline === 'All disciplines' ? null : selectedDiscipline,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <div className="bg-gradient-to-r from-blue-700 to-blue-900 text-white p-4 shadow-md">
        <div className="flex items-center justify-between max-w-7xl mx-auto">
          ...
          <nav className="flex space-x-6">
            ...
            <a href="#" className="hover:text-blue-200 transition-colors">OPAC</a>
        ...
        <div className="flex-1 max-w-5xl bg-white bg-opacity-95 rounded-xl shadow-2xl p-8">
          {!searchResults ? (
            <div className="max-w-4xl mx-auto">
              ...
              {loading && (
                <div className="text-center text-blue-600 text-lg mt-8">
                  <div className="animate-spin inline-block w-8 h-8 border-4 border-blue-500 border-t-transparent rounded-full mr-2"></div>
      ...
      {/* Right Overlay for More Details */}
