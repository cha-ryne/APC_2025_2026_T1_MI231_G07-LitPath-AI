...
def extract_thesis_metadata(text):
    # TODO: Replace this stub with your actual metadata extraction logic
    return {
        "title": "",
        "author": "",
        "publication_year": "",
    ...
    def do_POST(self):
        if self.path == "/search":
            ...
            try:
                ...
                if relevant_chunks:
                    # Always build context from up to 5 unique theses (by file/pdf)
                    unique_files = []
                    chunks_for_overview = []
                    for c in relevant_chunks:
                        ...
                        if len(unique_files) >= 5:
                            # Optionally, only include chunks from these 5 unique sources
                            break
